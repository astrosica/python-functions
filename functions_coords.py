...
rc("text", usetex=True)def fdegtosexa(ra_deg,dec_deg):
	'''
	Converts Right Ascension and Declination from decimal degrees to the sexagismal system. Inputs integers, floats, lists or arrays.
	'''
...
def fmatchpos(names,ra1,dec1,ra2,dec2,minarcsec,fdir=None,fname=None,N1=None,N2=None,x1min=None,x1max=None,x2min=None,x2max=None,xlabel1=None,xlabel2=None,ylabel1=None,ylabel2=None,deg=True):
	'''
	Match two sets of coordinate positions in equatorial coordinates by projecting (ra1,dec1) onto (ra2,dec2).
